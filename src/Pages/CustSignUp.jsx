...
const Signup = () => {
  ...
  return (
    <form
      className="max-w-sm p-5 mx-auto my-16 fromTop rounded-2xl"
      onSubmit={handleSubmit}
    >
      <h2 className="flex justify-center items-center mx-auto my-0 text-xl font-medium uppercase tracking-wider">
    Sign Up as a User
      </h2>
